...
from sciretriever.catalog import IdentityResolver, PackageVersionRepository, ProcessingRunRepository, initialize_catalog, create_catalog_engine
...
class PackageRepositoryTests(TestCase):
    def setUp(self) -> None:
        ...
        self.work_version_id = IdentityResolver(self.catalog).create_or_reuse_work({"doi": "10.1/package"}).work_version.id
