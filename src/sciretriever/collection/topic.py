...
from sciretriever.model.collection import ValidatedTopicConditionSet
...
class TopicConditions:
    ...
    def validated(self) -> ValidatedTopicConditionSet:
        ...
        return ValidatedTopicConditionSet(
            canonical_json=payload.decode("ascii"), sha256=sha256_digest(payload)
        )


def validate_topic_condition_set(value: ValidatedTopicConditionSet) -> None:
...
__all__ = ("TopicConditions", "validate_topic_condition_set")
