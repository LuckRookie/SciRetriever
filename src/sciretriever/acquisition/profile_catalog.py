...
ACS_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    policy_revision="acs-browser-conservative-v1",
    ...
    evidence=PublisherAccessEvidence(
        ...
        verification_date=date(2026, 8, 19),
        evidence_revision="acs-persistent-browser-pdf-v4-2026-08-21",
...
AIP_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    browser_probe_enabled=True,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    policy_revision="aip-browser-conservative-v1",
    production_status=ProfileProductionStatus.PRODUCTION_READY,
    evidence=PublisherAccessEvidence(
        ...
        verification_date=date(2026, 8, 19),
        evidence_revision="aip-persistent-browser-pdf-v4-2026-08-21",
...
ELSEVIER_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    stable_locator_namespaces=("doi", "pii", "elsevier-article-eid"),
    provider_record_names=(),
    ...
    browser_probe_enabled=True,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    policy_revision="elsevier-browser-conservative-v1",
    production_status=ProfileProductionStatus.PRODUCTION_READY,
    evidence=PublisherAccessEvidence(
        ...
        verification_date=date(2026, 8, 19),
        evidence_revision="elsevier-api-persistent-browser-pdf-v3-2026-08-21",
...
IOP_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    browser_probe_enabled=True,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    policy_revision="iop-browser-conservative-v1",
    production_status=ProfileProductionStatus.PRODUCTION_READY,
    evidence=PublisherAccessEvidence(
        ...
        verification_date=date(2026, 8, 19),
        evidence_revision="iopscience-persistent-browser-pdf-v4-2026-08-21",
...
OXFORD_ACADEMIC_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    browser_probe_enabled=True,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    policy_revision="oup-browser-conservative-v1",
    production_status=ProfileProductionStatus.PRODUCTION_READY,
    evidence=PublisherAccessEvidence(
        ...
        verification_date=date(2026, 8, 19),
        evidence_revision="oxford-persistent-browser-pdf-v3-2026-08-21",
...
RSC_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    browser_probe_enabled=True,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    policy_revision="rsc-browser-conservative-v1",
    production_status=ProfileProductionStatus.PRODUCTION_READY,
    evidence=PublisherAccessEvidence(
        ...
        verification_date=date(2026, 8, 19),
        evidence_revision="rsc-persistent-browser-pdf-v4-2026-08-21",
...
SCIENCE_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    browser_probe_enabled=True,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    policy_revision="science-browser-conservative-v1",
    production_status=ProfileProductionStatus.PRODUCTION_READY,
    evidence=PublisherAccessEvidence(
        ...
        evidence_revision="science-persistent-browser-pdf-v4-2026-09-04",
...
SPRINGERLINK_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    evidence=PublisherAccessEvidence(
        ...
        evidence_revision="springerlink-persistent-browser-pdf-v6-2026-08-21",
        notes_reference="docs/notes/providers/springer-nature.md",
...
WILEY_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    browser_probe_enabled=True,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    policy_revision="wiley-browser-conservative-v1",
    production_status=ProfileProductionStatus.PRODUCTION_READY,
    evidence=PublisherAccessEvidence(
        ...
        verification_date=date(2026, 8, 19),
        evidence_revision="wiley-api-persistent-browser-pdf-v3-2026-08-21",
