...
ACS_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    public_route_keys=(),
    api_route_keys=(),
    browser_route_key="browser:acs-publications",
    browser_allowed_origins=("https://pubs.acs.org",),
    browser_rate_limit_group="acs-publications",
    browser_session_key="acs-publications",
    browser_rule_id="acs-publications-pdf",
    browser_rule_revision=3,
    ...
    browser_policy=BrowserGroupPolicy(
        rate_limit_group="acs-publications",
        policy_revision="acs-browser-conservative-v1",
...
AIP_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    public_route_keys=(),
    api_route_keys=(),
    browser_route_key="browser:aip-publishing",
    browser_allowed_origins=("https://pubs.aip.org",),
    browser_rate_limit_group="aip-publishing",
    browser_session_key="aip-publishing",
    browser_rule_id="aip-publishing-pdf",
    browser_rule_revision=3,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    ...
    browser_policy=BrowserGroupPolicy(
        rate_limit_group="aip-publishing",
        policy_revision="aip-browser-conservative-v1",
        minimum_start_interval=30.0,
        rate_limit_cooldown=600.0,
        runtime_failure_threshold=2,
...
ELSEVIER_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    browser_route_key="browser:elsevier-sciencedirect",
    browser_allowed_origins=(
        "https://www.sciencedirect.com",
        "https://linkinghub.elsevier.com",
        "https://pdf.sciencedirectassets.com",
    ...
    browser_rate_limit_group="elsevier",
    browser_session_key="elsevier",
    browser_rule_id="sciencedirect-pdf",
    browser_rule_revision=3,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
...
IOP_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    public_route_keys=(),
    api_route_keys=(),
    browser_route_key="browser:iopscience",
    browser_allowed_origins=("https://iopscience.iop.org",),
    browser_rate_limit_group="iopscience",
    browser_session_key="iopscience",
    browser_rule_id="iopscience-pdf",
    browser_rule_revision=2,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
...
OXFORD_ACADEMIC_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    public_route_keys=(),
    api_route_keys=(),
    browser_route_key="browser:oxford-academic",
    browser_allowed_origins=("https://academic.oup.com",),
    browser_rate_limit_group="oxford-academic",
    browser_session_key="oxford-academic",
    browser_rule_id="oxford-academic-pdf",
    browser_rule_revision=3,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    ...
    browser_policy=BrowserGroupPolicy(
        rate_limit_group="oxford-academic",
        policy_revision="oup-browser-conservative-v1",
        minimum_start_interval=30.0,
        rate_limit_cooldown=600.0,
        runtime_failure_threshold=2,
...
RSC_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    public_route_keys=(),
    api_route_keys=(),
    browser_route_key="browser:rsc-publishing",
    browser_allowed_origins=("https://pubs.rsc.org",),
    browser_rate_limit_group="rsc-publishing",
    browser_session_key="rsc-publishing",
    browser_rule_id="rsc-publishing-pdf",
    browser_rule_revision=3,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    ...
    browser_policy=BrowserGroupPolicy(
        rate_limit_group="rsc-publishing",
        policy_revision="rsc-browser-conservative-v1",
        minimum_start_interval=30.0,
        rate_limit_cooldown=600.0,
        runtime_failure_threshold=2,
...
SCIENCE_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    public_route_keys=(),
    api_route_keys=(),
    browser_route_key="browser:science-aaas",
    browser_allowed_origins=("https://www.science.org",),
    browser_rate_limit_group="science-aaas",
    browser_session_key="science-aaas",
    browser_rule_id="science-aaas-pdf",
    browser_rule_revision=3,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
    ...
    evidence=PublisherAccessEvidence(
        ...
        verification_date=date(2026, 8, 19),
        evidence_revision="science-persistent-browser-pdf-v3-2026-08-21",
...
WILEY_ACCESS_PROFILE: Final[PublisherAccessProfile] = PublisherAccessProfile(
    ...
    browser_rate_limit_group="wiley",
    browser_session_key="wiley",
    browser_rule_id="wiley-online-library-pdf",
    browser_rule_revision=3,
    policy_evidence=PolicyEvidence.PROJECT_CONSERVATIVE,
...
PUBLISHER_ACCESS_VERIFICATION_MATRIX: Final[PublisherAccessVerificationMatrix] = (
    PublisherAccessVerificationMatrix(
        ...
        browser_rules=BROWSER_RULE_VERIFICATION_CATALOG,
    )
)
...
if PUBLISHER_ACCESS_VERIFICATION_MATRIX.production_browser_rules != PRODUCTION_BROWSER_RULE_CATALOG:
    raise ValueError("production Browser rule catalog disagrees with verified profiles")
