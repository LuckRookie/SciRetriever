...
# Catalog bootstrap, validation, and connection policy form one persistence boundary.
...
from sciretriever.infrastructure.storage.sqlite.bootstrap import recover_bootstrap_temps
from sciretriever.infrastructure.storage.sqlite.schema import SCHEMA_FINGERPRINT, SCHEMA_MANIFEST
from sciretriever.infrastructure.storage.sqlite.schema_validation import (
