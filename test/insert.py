...
year_list = [2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,
             ...
             2022,2023,2024,2025]
root_dir = Path("/workplace/duanjw/project/google/energetic_materials")
...
for year in year_list:
    ...
    # filter
    papers = [paper for list_paper in paperss for paper in list_paper if paper.type=="article" and filter_title(paper.title)]
    
    print("papers:",len(papers))
    
    insert_paper_to_db(
        db_dir='/workplace/duanjw/project/SciRetriever/GS.db',
