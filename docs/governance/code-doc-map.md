...
| `src/sciretriever/cli/`、`src/sciretriever/config.py`、`config.example.toml` | [README](../../README.md)、[需求](../specs/requirements.md)、[AGENTS.md](../../AGENTS.md)、[实施进度](implementation-progress.md) | 已发布命令、参数、stop/force/optional/import 语义、accepted keys/defaults、composition ownership，理想 CLI/config contract 和当前差距 |
