...
| `src/sciretriever/literature_store/` | [设计文档](../architecture/design.md)、[技术文档](../architecture/technical.md) | 目标 SQLite schema manifest/fingerprint、fresh-only bootstrap、只读验证、事务边界、通用 opaque extension 记录和描述符安全文件系统原语；公开切换前不得写成当前 CLI 行为 |
